...
class InfrastructureCache:
    ...
    def _build_catalog(
        ...
        return build_infrastructure_catalog(
            substations,
            transmission_lines,
            fiber_cables,
            ixps,
...
async def calculate_proximity_scores_batch(projects: List[Dict[str, Any]]) -> List[Dict[str, float]]:
    ...
    return calculate_proximity_scores_for_catalog(projects, catalog)
...
async def analyze_for_power_developer(
    ...
    return await run_power_developer_analysis(
        ...
        get_color_from_score=get_color_from_score,
        get_rating_description=get_rating_description,
    )
